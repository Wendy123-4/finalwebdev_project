...
function apply(){
	// call these variables with the global keyword to make them available in function
	global $db2, $errors, $candidate_name, $candidate_email, $about_yourself, $interests, $why_asa, $transcript;
	...
	if (count($errors) == 0) {
        ...
        $query2 = "INSERT INTO form (candidate_name, candidate_email,contact, address, about_yourself,interests,why_asa)
